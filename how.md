...
- Uygulama, README'de de belirtildiği gibi, ciddi bir insan code review'undan geçmemiştir. Linux tarafında en az 6 farklı derleme/yayın hatası vardı ve bunlar ancak bu oturumda gerçek CI çalıştırmaları izlenerek bulunup düzeltildi — bu da projenin ilk halinin hiç test edilmeden/derlenmeden commit edildiğini gösteriyor.
